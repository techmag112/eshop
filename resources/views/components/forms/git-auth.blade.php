<div class="space-y-3 mt-5">
    <ul>
        <li>
            <a href="{{ route('socialite.redirect') }}" class="relative flex items-center h-14 px-12 rounded-lg border border-[#A07BF0] bg-white/20 hover:bg-white/20 active:bg-white/10 active:translate-y-0.5">
